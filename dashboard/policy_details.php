...
$policy = get_by_id('policy', security('id', 'GET'));
...
$benz = explode(",", $policy['policy_benefits']);

$benefits = [];

foreach($benz as $b){
    $sql = "SELECT * FROM benefit WHERE benefit_id = '$b' ";
...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><?= $user['user_name'] ?> </h4>
    <div class="row">
        <!-- User Sidebar -->
                ...
                <div class="card-body">
                    <div class="user-avatar-section">
                        <div class="d-flex align-items-center flex-column">
                            <img class="img-fluid rounded my-4" src="<?= file_url . 'default.png' ?>" height="110" width="110" alt="User avatar" />
                            <div class="user-info text-center">
                                <h4 class="mb-2"><?= $product['product_name'] ?></h4>
                                <span class="badge bg-label-secondary">User Details</span>
                            </div>
                        </div>
                    </div>

                    <h5 class="pb-2 border-bottom mt-4 mb-4">User Details</h5>
